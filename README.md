...
This app is designed to run on shared hosting (e.g., domain registrar) via Passenger WSGI. It can also run locally or on any standard WSGI-compatible environment.
