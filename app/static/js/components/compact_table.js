...
BW.CompactTable = {
    ...
    updateTableData: function (commodities) {
        ...
        if (commodities.length === 0) {
            tbody.innerHTML = `
                <tr>
                    <td colspan="6" class="py-8 text-center text-brand-black-60 dark:text-brand-black-60 font-ui text-xs">
                        <div class="empty-state">
                            <svg class="w-8 h-8 mx-auto mb-2 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                            </svg>
                            <p class="font-bold">No data available in range</p>
                            <p>Try selecting a different time range or wait for the next data update.</p>
                        </div>
                    </td>
                </tr>
            `;
